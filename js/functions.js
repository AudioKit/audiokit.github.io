...
var requesting = !1,
    ...
    SEMICOLON = SEMICOLON || {}! function(e) {
        "use strict"
        SEMICOLON.initialize = {
            ...
            verticalMiddle: function() {
                B.length > 0 && B.each(function() {
                    var t = e(this),
                        i = t.outerHeight(),
                        n = s.outerHeight()
                    t.parents("#slider").length > 0 && !t.hasClass("ignore-header") && s.hasClass("transparent-header") && (a.hasClass("device-lg") || a.hasClass("device-md")) && (i -= 70, E.next("#header").length > 0 && (i += n)), (a.hasClass("device-xs") || a.hasClass("device-xxs")) && t.parents(".full-screen").length && !t.parents(".force-full-screen").length ? t.children(".col-padding").length > 0 ? t.css({
                        position: "relative",
                        top: "0",
                        width: "auto",
                        marginTop: "0"
            ...
            goToTopScroll: function() {
                ...
                return i || (i = 450), "true" != e && (a.hasClass("device-xs") || a.hasClass("device-xxs")) ? !0 : void(t.scrollTop() > +i ? V.fadeIn() : V.fadeOut())
            },
            fullScreen: function() {
                Y.length > 0 && Y.each(function() {
                    ...
                    if ("slider" == i.attr("id")) {
                        ...
                        if (n -= r, i.find(".slider-parallax-inner").length > 0) {
                            ...
                            n = (window.innerHeight ? window.innerHeight : t.height()) + +c - r
                        }
                    ...
                    i.parents(".full-screen").length > 0 && (n = i.parents(".full-screen").height()), (a.hasClass("device-xs") || a.hasClass("device-xxs")) && (i.hasClass("force-full-screen") || (n = "auto")), o && (n -= +o), i.css("height", n), "slider" != i.attr("id") || i.hasClass("canvas-slider-grid") || i.has(".swiper-slide") && i.find(".swiper-slide").css("height", n)
                })
            },
            maxHeight: function() {
                if ($.length > 0) {
            ...
            pageTransition: function() {
                ...
                var t = a.attr("data-animation-in"),
                    ...
                    m = "",
                    g = ""
                t || (t = "fadeIn"), s || (s = "fadeOut"), n || (n = 1500), o || (o = 800), c || (c = '<div class="css3-spinner-bounce1"></div><div class="css3-spinner-bounce2"></div><div class="css3-spinner-bounce3"></div>'), r = r ? +r : !1, d && ("theme" == d ? (f = " bgcolor", p = " border-color", m = ' class="bgcolor"', g = ' class="border-color"') : (u = ' style="background-color:' + d + ';"', h = ' style="border-color:' + d + ';"'), c = '<div class="css3-spinner-bounce1' + f + '"' + u + '></div><div class="css3-spinner-bounce2' + f + '"' + u + '></div><div class="css3-spinner-bounce3' + f + '"' + u + "></div>"), "2" == l ? c = '<div class="css3-spinner-flipper' + f + '"' + u + "></div>" : "3" == l ? c = '<div class="css3-spinner-double-bounce1' + f + '"' + u + '></div><div class="css3-spinner-double-bounce2' + f + '"' + u + "></div>" : "4" == l ? c = '<div class="css3-spinner-rect1' + f + '"' + u + '></div><div class="css3-spinner-rect2' + f + '"' + u + '></div><div class="css3-spinner-rect3' + f + '"' + u + '></div><div class="css3-spinner-rect4' + f + '"' + u + '></div><div class="css3-spinner-rect5' + f + '"' + u + "></div>" : "5" == l ? c = '<div class="css3-spinner-cube1' + f + '"' + u + '></div><div class="css3-spinner-cube2' + f + '"' + u + "></div>" : "6" == l ? c = '<div class="css3-spinner-scaler' + f + '"' + u + "></div>" : "7" == l ? c = '<div class="css3-spinner-grid-pulse"><div' + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div></div>" : "8" == l ? c = '<div class="css3-spinner-clip-rotate"><div' + g + h + "></div></div>" : "9" == l ? c = '<div class="css3-spinner-ball-rotate"><div' + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div></div>" : "10" == l ? c = '<div class="css3-spinner-zig-zag"><div' + m + u + "></div><div" + m + u + "></div></div>" : "11" == l ? c = '<div class="css3-spinner-triangle-path"><div' + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div></div>" : "12" == l ? c = '<div class="css3-spinner-ball-scale-multiple"><div' + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div></div>" : "13" == l ? c = '<div class="css3-spinner-ball-pulse-sync"><div' + m + u + "></div><div" + m + u + "></div><div" + m + u + "></div></div>" : "14" == l && (c = '<div class="css3-spinner-scale-ripple"><div' + g + h + "></div><div" + g + h + "></div><div" + g + h + "></div></div>"), i.animsition({
                    inClass: t,
                    outClass: s,
                    inDuration: +n,
                    outDuration: +o,
            ...
            defineColumns: function(e) {
                ...
                if (e.hasClass("portfolio-full")) t = e.hasClass("portfolio-3") ? 3 : e.hasClass("portfolio-5") ? 5 : e.hasClass("portfolio-6") ? 6 : 4, !a.hasClass("device-sm") || 4 != t && 5 != t && 6 != t ? !a.hasClass("device-xs") || 3 != t && 4 != t && 5 != t && 6 != t ? a.hasClass("device-xxs") && (t = 1) : t = 2 : t = 3
                    ...
                    t = e.hasClass("col-2") ? 2 : e.hasClass("col-3") ? 3 : e.hasClass("col-5") ? 5 : e.hasClass("col-6") ? 6 : 4, a.hasClass("device-lg") ? i && (t = +i) : a.hasClass("device-md") ? s && (t = +s) : a.hasClass("device-sm") ? n && (t = +n) : a.hasClass("device-xs") ? o && (t = +o) : a.hasClass("device-xxs") && r && (t = +r)
                }
                return t
            },
            setFullColumnWidth: function(t) {
                ...
                if (t.css({
                    ...
                    if (d) {
                        ...
                        var c = "",
                            u = ""
                        for (u = 0; u < d.length; u++) c = +d[u] - 1, t.find("a:eq(" + c + ")").css({
                            width: 2 * r + "px"
                        })
                        setTimeout(function() {
                            t.isotope("layout")
            ...
            stickFooterOnSmall: function() {
                var e = t.height(),
                    s = i.height() !a.hasClass("sticky-footer") && r.length > 0 && i.has("#footer") && e > s && r.css({
                        "margin-top": e - s
                    })
            },
                ...
                if (x.length > 0) {
                    ...
                    t || (t = 1e3), s || (s = "easeOutQuad"), x.find("a[data-href]").click(function() {
                        ...
                        if (e(o).length > 0) {
                            ...
                            r || (r = t), d || (d = u), c || (c = s), x.hasClass("no-offset") && (d = 0), I = +d, x.find("li").removeClass("current"), x.find('a[data-href="' + o + '"]').parent("li").addClass("current"), 768 > l || a.hasClass("overlay-menu") ? e("#primary-menu").find("ul.mobile-primary-menu").length > 0 ? e("#primary-menu > ul.mobile-primary-menu, #primary-menu > div > ul.mobile-primary-menu").toggleClass("show", function() {
                                e("html,body").stop(!0).animate({
                                    scrollTop: e(o).offset().top - +d
                                }, +r, c)
            ...
            logo: function() {
                !s.hasClass("dark") && !a.hasClass("dark") || n.hasClass("not-dark") ? (m && f.find("img").attr("src", m), g && p.find("img").attr("src", g)) : (v && f.find("img").attr("src", v), C && p.find("img").attr("src", C)), s.hasClass("sticky-header") && (O && f.find("img").attr("src", O), y && p.find("img").attr("src", y)), (a.hasClass("device-xs") || a.hasClass("device-xxs")) && (S && f.find("img").attr("src", S), b && p.find("img").attr("src", b))
            },
            ...
            sliderParallaxDimensions: function() {
                if (L.find(".slider-parallax-inner").length < 1) return !0
                var e = L.outerHeight(),
                    t = L.outerWidth();
                (L.hasClass("revslider-wrap") || L.find(".carousel-widget").length > 0) && (e = L.find(".slider-parallax-inner").children().first().outerHeight(), L.height(e)), L.find(".slider-parallax-inner").height(e), a.hasClass("side-header") && L.find(".slider-parallax-inner").width(t), a.hasClass("stretched") || (t = i.outerWidth(), L.find(".slider-parallax-inner").width(t)), "" != N && N.update(!0)
            },
            sliderRun: function() {
                if ("undefined" == typeof Swiper) return console.log("sliderRun: Swiper not Defined."), !0
                if (E.hasClass("customjs")) return !0
                if (E.hasClass("swiper_wrapper")) {
                    var t = E.filter(".swiper_wrapper"),
                    ...
                    if (i || (i = 300), a || (a = "horizontal"), s && (s = +s), n = "true" == n ? !0 : !1, o || (o = "slide"), r = "false" == r ? !1 : !0, c = "false" == c ? !1 : !0, t.find(".swiper-pagination").length > 0) var u = ".swiper-pagination",
                        h = !0
                    else var u = "",
                        h = !1
                    var f = "#slider-arrow-right",
                        p = "#slider-arrow-left"
                    N = new Swiper(t.find(".swiper-parent"), {
                        direction: a,
                        speed: +i,
                        autoplay: s,
                        loop: n,
                        ...
                        onInit: function(a) {
                            SEMICOLON.slider.sliderParallaxDimensions(), t.find(".yt-bg-player").removeClass("customjs"), SEMICOLON.widget.youtubeBgVideo(), e(".swiper-slide-active [data-caption-animate]").each(function() {
                                var t = e(this),
                                    ...
                                    i = 0
                                if (i = a ? +a + 750 : 750, !t.hasClass("animated")) {
                        ...
                        onSlideChangeStart: function(a) {
                            d.length > 0 && (1 == n ? d.html(+t.find(".swiper-slide.swiper-slide-active").attr("data-swiper-slide-index") + 1) : d.html(N.activeIndex + 1)), e("[data-caption-animate]").each(function() {
                                var t = e(this),
                                    a = t.attr("data-caption-animate")
                                return t.parents(".swiper-slide").hasClass("swiper-slide-active") ? !0 : void t.removeClass("animated").removeClass(a).addClass("not-animated")
                            }), SEMICOLON.slider.swiperSliderMenu()
                        ...
                        onSlideChangeEnd: function(a) {
                            t.find(".swiper-slide").each(function() {
                                ...
                                var t = e(this),
                                    a = t.attr("data-caption-delay"),
                                    i = 0
                                if (i = a ? +a + 300 : 300, !t.hasClass("animated")) {
                                    t.addClass("not-animated")
                                    var s = t.attr("data-caption-animate")
                                    setTimeout(function() {
                                        t.removeClass("not-animated").addClass(s + " animated")
                    ...
                    }), d.length > 0 && (1 == n ? d.html(+t.find(".swiper-slide.swiper-slide-active").attr("data-swiper-slide-index") + 1) : d.html(N.activeIndex + 1)), l.length > 0 && l.html(t.find(".swiper-slide:not(.swiper-slide-duplicate)").length)
                }
            },
            sliderParallaxOffset: function() {
                ...
                return E.next("#header").length > 0 && (e = 0), e
            },
            sliderParallax: function() {
                if (L.length < 1) return !0
                var i = SEMICOLON.slider.sliderParallaxOffset(),
                    s = L.outerHeight()
                if (!a.hasClass("device-lg") && !a.hasClass("device-md") || SEMICOLON.isMobile.any()) L.find(".slider-parallax-inner").length > 0 ? e(".slider-parallax-inner,.slider-parallax .slider-caption,.ei-title").css({
                    ...
                    if (s + i + 50 > t.scrollTop())
                        if (L.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible"), t.scrollTop() > i)
                            if (L.find(".slider-parallax-inner").length > 0) {
                                var n = ((t.scrollTop() - i) * -.4).toFixed(0),
                                    o = ((t.scrollTop() - i) * -.15).toFixed(0)
                                L.find(".slider-parallax-inner").css({
                            ...
                            } else L.find(".slider-parallax-inner").length > 0 ? e(".slider-parallax-inner,.slider-parallax .slider-caption,.ei-title").css({
                        transform: "translateY(0px)"
                    }) : e(".slider-parallax,.slider-parallax .slider-caption,.ei-title").css({
                        transform: "translateY(0px)"
                    })
                    else L.addClass("slider-parallax-invisible").removeClass("slider-parallax-visible")
            ...
            sliderElementsFade: function() {
                if (L.length > 0)
                    if (!a.hasClass("device-lg") && !a.hasClass("device-md") || SEMICOLON.isMobile.any()) L.find("#slider-arrow-left,#slider-arrow-right,.vertical-middle:not(.no-fade),.slider-caption,.ei-title,.camera_prev,.camera_next").css({
                        opacity: 1
                    })
                    else {
                        var i = (SEMICOLON.slider.sliderParallaxOffset(), L.outerHeight())
                        if (E.length > 0) {
                            if (s.hasClass("transparent-header") || e("body").hasClass("side-header")) var n = 100
                            else var n = 0
                            L.find("#slider-arrow-left,#slider-arrow-right,.vertical-middle:not(.no-fade),.slider-caption,.ei-title,.camera_prev,.camera_next").css({
            ...
            captionPosition: function() {
                E.find(".slider-caption:not(.custom-caption-pos)").each(function() {
            ...
            swiperSliderMenu: function(e) {
                if (e = void 0 !== e ? e : !1, a.hasClass("device-lg") || a.hasClass("device-md")) {
                    var t = E.find(".swiper-slide.swiper-slide-active")
            ...
            animations: function() {
                ...
                t.length > 0 && (a.hasClass("device-lg") || a.hasClass("device-md") || a.hasClass("device-sm")) && t.each(function() {
                    ...
                    if (n = i ? +i + 500 : 500, a && s && (o = +s + n), !t.hasClass("animated")) {
                        t.addClass("not-animated")
            ...
            loadFlexSlider: function() {
                ...
                t.length > 0 && t.each(function() {
                    var t = e(this),
                        ...
                        p = !1
                    a || (a = "slide"), i && "swing" != i || (i = "swing", p = !0), s || (s = "horizontal"), n = n ? !1 : !0, o || (o = 5e3), r || (r = 600), l || (l = !1), f = "false" == f ? !1 : !0, "vertical" == s && (f = !1), d = "false" == d ? !1 : !0, d = "true" == u ? "thumbnails" : d, c = "false" == c ? !1 : !0, h = "false" == h ? !1 : !0, t.flexslider({
            ...
            youtubeBgVideo: function() {
                return e().mb_YTPlayer ? Z.hasClass("customjs") ? !0 : void(Z.length > 0 && Z.each(function() {
                    ...
                    i = "false" == i ? !1 : !0, s || (s = "16/9"), n || (n = "hd720"), o || (o = 1), r || (r = "self"), l = "false" == l ? !1 : !0, d = "false" == d ? !1 : !0, c || (c = 1), u || (u = 0), h || (h = 0), f = "false" == f ? !1 : !0, p = "true" == p ? !0 : !1, t.mb_YTPlayer({
                        videoURL: a,
                        mute: i,
                        ratio: s,
                        quality: n,
            ...
            accordions: function() {
                ...
                t.length > 0 && t.each(function() {
                    var t = e(this),
                        a = t.attr("data-state"),
                        i = t.attr("data-active")
                    i ? i -= 1 : i = 0, t.find(".acc_content").hide(), "closed" != a && t.find(".acctitle:eq(" + +i + ")").addClass("acctitlec").next().show(), t.find(".acctitle").click(function() {
            ...
            runRoundedSkills: function(e, t) {
                e.easyPieChart({
                    size: +t.roundSkillSize,
                    animate: +t.roundSkillSpeed,
                    scaleColor: !1,
                    trackColor: t.roundSkillTrackColor,
                    lineWidth: +t.roundSkillWidth,
                    lineCap: "square",
            ...
            navTree: function() {
                ...
                t.length > 0 && t.each(function() {
                    ...
                    a || (a = 250), i || (i = "swing"), t.find("ul li:has(ul)").addClass("sub-menu"), t.find("ul li:has(ul) > a").append(' <i class="icon-angle-down"></i>'), t.hasClass("on-hover") ? t.find("ul li:has(ul):not(.active)").hover(function(t) {
                        e(this).children("ul").stop(!0, !0).slideDown(+a, i)
                    }, function() {
                        e(this).children("ul").delay(250).slideUp(+a, i)
                    }) : t.find("ul li:has(ul) > a").click(function(s) {
                        var n = e(this)
                        t.find("ul li").not(n.parents()).removeClass("active"), n.parent().children("ul").slideToggle(+a, i, function() {
                            e(this).find("ul").hide(), e(this).find("li.active").removeClass("active")
                        }), t.find("ul li > ul").not(n.parent().children("ul")).not(n.parents("ul")).slideUp(+a, i), n.parent("li:has(ul)").toggleClass("active"), s.preventDefault()
                    })
                })
            },
            carousel: function() {
                ...
                return t.length < 1 ? !0 : void t.each(function() {
                    var t = e(this),
                        ...
                        C = t.attr("data-merge"),
                        O = t.attr("data-start"),
                        y = t.attr("data-rewind"),
                        S = t.attr("data-slideby"),
                        b = t.attr("data-center"),
                        w = t.attr("data-lazyload"),
                        x = t.attr("data-video"),
                        I = t.attr("data-rtl")
                    if (i || (i = 4), s || (s = +i), n || (n = +s), o || (o = +n), r || (r = +o), l || (l = +r), u || (u = 250), g || (g = 20), v || (v = 0), O || (O = 0), S || (S = 1), S = "page" == S ? "page" : +S, d = "true" == d ? !0 : !1, c) {
                        var M = +c
                        c = !0
                    } else {
                        c = !1
                    ...
                    h || (h = !1), f || (f = !1), p = "false" == p ? !1 : !0, m = "false" == m ? !1 : !0, y = "true" == y ? !0 : !1, C = "true" == C ? !0 : !1, b = "true" == b ? !0 : !1, w = "true" == w ? !0 : !1, x = "true" == x ? !0 : !1, I = "true" == I || a.hasClass("rtl") ? !0 : !1, t.owlCarousel({
                        margin: +g,
                        loop: d,
                        stagePadding: +v,
                        merge: C,
            ...
            init: function() {
                setTimeout(function() {
                    SEMICOLON.header.topsocial(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.overlayMenu(), SEMICOLON.initialize.fullScreen(), SEMICOLON.initialize.verticalMiddle(), SEMICOLON.initialize.maxHeight(), SEMICOLON.initialize.testimonialsGrid(), SEMICOLON.initialize.stickyFooter(), SEMICOLON.slider.sliderParallaxDimensions(), SEMICOLON.slider.captionPosition(), SEMICOLON.portfolio.arrange(), SEMICOLON.portfolio.portfolioDescMargin(), SEMICOLON.widget.tabsJustify(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.initialize.dataResponsiveHeights(), k.length > 0 && (k.hasClass(".customjs") || (e().isotope ? k.isotope("layout") : console.log("documentOnResize > init: Isotope not defined."))), (a.hasClass("device-lg") || a.hasClass("device-md")) && e("#primary-menu").find("ul.mobile-primary-menu").removeClass("show")
                }, 500)
                l = t.width()
            }
        }, SEMICOLON.documentOnReady = {
            init: function() {
                SEMICOLON.initialize.init(), SEMICOLON.header.init(), E.length > 0 && SEMICOLON.slider.init(), M.length > 0 && SEMICOLON.portfolio.init(), SEMICOLON.widget.init(), SEMICOLON.documentOnReady.windowscroll()
            },
        ...
        var t = e(window),
            ...
            p = (f.find("img").outerWidth(), e("#logo").find(".retina-logo")),
            m = f.find("img").attr("src"),
            g = p.find("img").attr("src"),
            v = f.attr("data-dark-logo"),
            C = p.attr("data-dark-logo"),
            O = f.attr("data-sticky-logo"),
            y = p.attr("data-sticky-logo"),
            S = f.attr("data-mobile-logo"),
            b = p.attr("data-mobile-logo"),
            w = e("#page-menu"),
            x = e(".one-page-menu"),
            I = 0,
            M = e(".portfolio"),
            k = (e(".shop"), e(".grid-container")),
            E = e("#slider"),
            L = e(".slider-parallax"),
            N = "",
            T = e("#page-title"),
